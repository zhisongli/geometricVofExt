...
Foam::label Foam::TwoPhaseFlow::implicitInterfaceDiffFlux::getCellLabel
(
...
void Foam::TwoPhaseFlow::implicitInterfaceDiffFlux::getNeigbours
(
    const label celli,
...
Foam::TwoPhaseFlow::implicitInterfaceDiffFlux::implicitInterfaceDiffFlux
(
    const fvMesh& mesh
)
:
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::implicitInterfaceDiffFlux::diffusiveFlux
(
...
Foam::tmp<Foam::fvScalarMatrix> Foam::TwoPhaseFlow::implicitInterfaceDiffFlux::diffusiveFlux
(
    const boolList& markedCells,
    const volVectorField& normal,
    const volVectorField& centre,
...
void Foam::TwoPhaseFlow::implicitInterfaceDiffFlux::diffusiveFlux
(
    const boolList& markedCells,
    const volVectorField& normal,
    const volVectorField& centre,
