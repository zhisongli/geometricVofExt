...
Foam::TwoPhaseFlow::explicitInterfaceDiffFlux::explicitInterfaceDiffFlux
(
    const fvMesh& mesh
)
:
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::explicitInterfaceDiffFlux::diffusiveFlux
(
...
Foam::tmp<Foam::fvScalarMatrix> Foam::TwoPhaseFlow::explicitInterfaceDiffFlux::diffusiveFlux
(
    const boolList& markedCells,
    const volVectorField& normal,
    const volVectorField& centre,
...
void Foam::TwoPhaseFlow::explicitInterfaceDiffFlux::diffusiveFlux
(
    const boolList& markedCells,
    const volVectorField& normal,
    const volVectorField& centre,
