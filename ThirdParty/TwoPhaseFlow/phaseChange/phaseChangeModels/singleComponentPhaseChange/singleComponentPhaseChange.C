...
Foam::TwoPhaseFlow::singleComponentPhaseChange::singleComponentPhaseChange
(
...
void Foam::TwoPhaseFlow::singleComponentPhaseChange::correct()
{
...
void Foam::TwoPhaseFlow::singleComponentPhaseChange::correctSatProperties
(
    const volScalarField& p,
