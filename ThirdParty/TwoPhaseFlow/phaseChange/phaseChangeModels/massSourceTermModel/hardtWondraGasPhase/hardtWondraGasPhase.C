...
{
    defineTypeNameAndDebug(hardtWondraGasPhase, 0);
    addToRunTimeSelectionTable(massSourceTermModel,hardtWondraGasPhase, components);
}
}

// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //

Foam::TwoPhaseFlow::hardtWondraGasPhase::hardtWondraGasPhase
(
...
Foam::TwoPhaseFlow::hardtWondraGasPhase::massSource( volScalarField& rhoSource)
{
...
Foam::tmp<Foam::volScalarField>
Foam::TwoPhaseFlow::hardtWondraGasPhase::alphaSource( volScalarField& rhoSource)
{
