...
Foam::TwoPhaseFlow::directEvaporation::directEvaporation
(
...
void Foam::TwoPhaseFlow::directEvaporation::TSource1(fvScalarMatrix& T1Eqn)
{
    Info << " Tsource " << endl;
...
void Foam::TwoPhaseFlow::directEvaporation::TSource2(fvScalarMatrix& T2Eqn)
{
...
void Foam::TwoPhaseFlow::directEvaporation::energySource(volScalarField& Q)
{
    ...
    const volVectorField& normal = reconstructor.interfaceS();
    const volScalarField& TSat = satModel_.TSat();
...
void Foam::TwoPhaseFlow::directEvaporation::energySource1(volScalarField& q1)
{

}


void Foam::TwoPhaseFlow::directEvaporation::energySource2(volScalarField& q2)
{

}


void Foam::TwoPhaseFlow::directEvaporation::massSource(volScalarField& rhoSource)
{

}

void Foam::TwoPhaseFlow::directEvaporation::alphaSource(volScalarField& rhoSource)
{
