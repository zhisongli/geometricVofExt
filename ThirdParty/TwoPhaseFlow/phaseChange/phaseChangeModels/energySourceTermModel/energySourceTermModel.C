...
Foam::TwoPhaseFlow::energySourceTermModel::energySourceTermModel
(
    const word& type,
...
Foam::TwoPhaseFlow::energySourceTermModel::modelDict() const
{
    return energySourceTermModelCoeffs_;
}

Foam::dictionary&
Foam::TwoPhaseFlow::energySourceTermModel::modelDict()
{
    return energySourceTermModelCoeffs_;
}
