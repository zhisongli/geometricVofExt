...
Foam::TwoPhaseFlow::singleComponentSatProp::singleComponentSatProp
(
    const fvMesh& mesh,
...
void Foam::TwoPhaseFlow::singleComponentSatProp::correct
(
...
Foam::scalar
Foam::TwoPhaseFlow::singleComponentSatProp::satP(scalar t) const
{
...
Foam::scalar
Foam::TwoPhaseFlow::singleComponentSatProp::satT(scalar p) const
{
...
Foam::scalar
Foam::TwoPhaseFlow::singleComponentSatProp::satL(scalar p) const
{
...
Foam::TwoPhaseFlow::singleComponentSatProp::modelDict() const
{
    return singleComponentSatPropCoeffs_;
}

Foam::dictionary&
Foam::TwoPhaseFlow::singleComponentSatProp::modelDict()
{
    return singleComponentSatPropCoeffs_;
}
