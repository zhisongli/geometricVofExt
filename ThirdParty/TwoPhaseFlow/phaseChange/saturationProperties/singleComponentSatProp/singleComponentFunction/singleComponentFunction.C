...
Foam::TwoPhaseFlow::singleComponentFunction::singleComponentFunction
(
    const fvMesh& mesh,
...
Foam::scalar
Foam::TwoPhaseFlow::singleComponentFunction::satT(scalar p) const
{
    return TSatFunc_->value(p);
}

Foam::scalar
Foam::TwoPhaseFlow::singleComponentFunction::satP(Foam::scalar T) const
{
    return pSatFunc_->value(T);
}

Foam::scalar
Foam::TwoPhaseFlow::singleComponentFunction::satL(Foam::scalar p) const
{
