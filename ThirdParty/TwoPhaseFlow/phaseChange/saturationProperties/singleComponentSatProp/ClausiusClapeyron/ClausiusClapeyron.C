...
Foam::TwoPhaseFlow::ClausiusClapeyron::ClausiusClapeyron
(
    const fvMesh& mesh,
...
Foam::scalar
Foam::TwoPhaseFlow::ClausiusClapeyron::C0()
{
...
Foam::scalar
Foam::TwoPhaseFlow::ClausiusClapeyron::satT(scalar p) const
{
...
Foam::scalar
Foam::TwoPhaseFlow::ClausiusClapeyron::satP(Foam::scalar T) const
{
...
Foam::scalar
Foam::TwoPhaseFlow::ClausiusClapeyron::satL(Foam::scalar p) const
{
    return L0_;
}
