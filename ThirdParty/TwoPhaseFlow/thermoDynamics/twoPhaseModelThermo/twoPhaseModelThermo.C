...
Foam::TwoPhaseFlow::twoPhaseModelThermo::twoPhaseModelThermo
(
...
Foam::TwoPhaseFlow::twoPhaseModelThermo::nearInterface() const
{
    return pos0(phase1_() - 0.01)*pos0(0.99 - phase1_());
}


void Foam::TwoPhaseFlow::twoPhaseModelThermo::correctThermo()
{
...
void Foam::TwoPhaseFlow::twoPhaseModelThermo::correct()
{
    psi_ =
...
Foam::word Foam::TwoPhaseFlow::twoPhaseModelThermo::thermoName() const
{
    return
        phase1_->thermo().thermoName() + ',' + phase2_->thermo().thermoName();
}

bool Foam::TwoPhaseFlow::twoPhaseModelThermo::incompressible() const
{
...
bool Foam::TwoPhaseFlow::twoPhaseModelThermo::isochoric() const
{
    return phase1_->thermo().isochoric() && phase2_->thermo().isochoric();
}


Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::he
(
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::he
(
    const scalarField& p,
    const scalarField& T,
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::hc() const
{
    return phase1_()*phase1_->thermo().hc() + phase2_()*phase2_->thermo().hc();
}


Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::THE
(
    const scalarField& h,
    const scalarField& p,
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::Cp() const
{
    return phase1_()*phase1_->thermo().Cp() + phase2_()*phase2_->thermo().Cp();
}


Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::Cp
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::Cv() const
{
    return phase1_()*phase1_->thermo().Cv() + phase2_()*phase2_->thermo().Cv();
}


Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::Cv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::rhoEoS
(
    const scalarField& p,
    const scalarField& T,
    const labelList& cells
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::gamma() const
{
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::gamma
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::Cpv() const
{
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::Cpv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::CpByCpv() const
{
    return
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::W() const
{
    return phase1_()*phase1_->thermo().W() + phase2_()*phase1_->thermo().W();
}


Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::CpByCpv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::nu() const
{
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::nu
(
    const label patchi
) const
{
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::kappa() const
{
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::kappa
(
    const label patchi
) const
{
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::alphahe() const
{
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::alphahe
(
    const label patchi
) const
{
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::kappaEff
(
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::kappaEff
(
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::alphaEff
(
    const volScalarField& alphat
) const
{
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseModelThermo::alphaEff
(
    const scalarField& alphat,
    const label patchi
) const
...
bool Foam::TwoPhaseFlow::twoPhaseModelThermo::read()
{
    if (psiThermo::read())
    {
