...
Foam::TwoPhaseFlow::MultiComponentPhaseModel<BasePhaseModel, phaseThermo>::
...
template<class BasePhaseModel, class phaseThermo>
const phaseThermo&
Foam::TwoPhaseFlow::MultiComponentPhaseModel<BasePhaseModel, phaseThermo>::thermo() const
{
    return thermoPtr_();
}
...
template<class BasePhaseModel, class phaseThermo>
phaseThermo&
Foam::TwoPhaseFlow::MultiComponentPhaseModel<BasePhaseModel, phaseThermo>::thermo()
{
    return thermoPtr_();
}

template<class BasePhaseModel, class phaseThermo>
void Foam::TwoPhaseFlow::MultiComponentPhaseModel<BasePhaseModel, phaseThermo>::correct()
{
    volScalarField Yt
    (
        IOobject
...
Foam::TwoPhaseFlow::MultiComponentPhaseModel<BasePhaseModel, phaseThermo>::YiEqn
(
    volScalarField& Yi,
...
Foam::TwoPhaseFlow::MultiComponentPhaseModel<BasePhaseModel, phaseThermo>::Y() const
{
...
Foam::TwoPhaseFlow::MultiComponentPhaseModel<BasePhaseModel, phaseThermo>::Y()
{
    return thermoPtr_->composition().Y();
}
...
template<class BasePhaseModel, class phaseThermo>
Foam::label
Foam::TwoPhaseFlow::MultiComponentPhaseModel<BasePhaseModel, phaseThermo>::inertIndex() const
{
    return inertIndex_;
}
