...
Foam::TwoPhaseFlow::twoPhaseMixtureThermo::twoPhaseMixtureThermo
(
...
void Foam::TwoPhaseFlow::twoPhaseMixtureThermo::correctThermo()
{
    ...
    he_ = alpha1()*thermo1_->he() + alpha2()*thermo2_->he();
}


void Foam::TwoPhaseFlow::twoPhaseMixtureThermo::correct()
{
...
Foam::word Foam::TwoPhaseFlow::twoPhaseMixtureThermo::thermoName() const
{
    return thermo1_->thermoName() + ',' + thermo2_->thermoName();
}


bool Foam::TwoPhaseFlow::twoPhaseMixtureThermo::incompressible() const
{
    return thermo1_->incompressible() && thermo2_->incompressible();
}


bool Foam::TwoPhaseFlow::twoPhaseMixtureThermo::isochoric() const
{
    return thermo1_->isochoric() && thermo2_->isochoric();
}


Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::he
(
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::he
(
    const scalarField& p,
    const scalarField& T,
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::hc() const
{
    return alpha1()*thermo1_->hc() + alpha2()*thermo2_->hc();
}


Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::THE
(
    const scalarField& h,
    const scalarField& p,
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::Cp() const
{
    return alpha1()*thermo1_->Cp() + alpha2()*thermo2_->Cp();
}


Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::Cp
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::Cv() const
{
    return alpha1()*thermo1_->Cv() + alpha2()*thermo2_->Cv();
}


Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::Cv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::rhoEoS
(
    const scalarField& p,
    const scalarField& T,
    const labelList& cells
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::gamma() const
{
    return alpha1()*thermo1_->gamma() + alpha2()*thermo2_->gamma();
}


Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::gamma
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::Cpv() const
{
    return alpha1()*thermo1_->Cpv() + alpha2()*thermo2_->Cpv();
}


Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::Cpv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::CpByCpv() const
{
    return
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::CpByCpv
(
    const scalarField& p,
    const scalarField& T,
    const label patchi
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::W() const
{
    return alpha1()*thermo1_->W() + alpha2()*thermo1_->W();
}


Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::nu() const
{
    return mu()/(alpha1()*thermo1_->rho() + alpha2()*thermo2_->rho());
}


Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::nu
(
    const label patchi
) const
{
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::kappa() const
{
    return alpha1()*thermo1_->kappa() + alpha2()*thermo2_->kappa();
}


Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::kappa
(
    const label patchi
) const
{
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::kappaEff
(
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::kappaEff
(
...
Foam::tmp<Foam::volScalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::alphaEff
(
    const volScalarField& alphat
) const
{
...
Foam::tmp<Foam::scalarField> Foam::TwoPhaseFlow::twoPhaseMixtureThermo::alphaEff
(
    const scalarField& alphat,
    const label patchi
) const
...
bool Foam::TwoPhaseFlow::twoPhaseMixtureThermo::read()
{
    if (psiThermo::read())
    {
