...
void Foam::TwoPhaseFlow::hTabulatedThermo<EquationOfState>::check
(
...
template<class EquationOfState>
void Foam::TwoPhaseFlow::hTabulatedThermo<EquationOfState>::readTable
(
...
template<class EquationOfState>
Foam::TwoPhaseFlow::hTabulatedThermo<EquationOfState>::hTabulatedThermo
(
...
template<class EquationOfState>
void Foam::TwoPhaseFlow::hTabulatedThermo<EquationOfState>::write
(
    Ostream& os
) const
{
...
template<class EquationOfState>
Foam::TwoPhaseFlow::Ostream& Foam::operator<<
(
    Ostream& os,
