...
void Foam::TwoPhaseFlow::tabulatedTransport<Thermo>::check
(
...
template<class Thermo>
void Foam::TwoPhaseFlow::tabulatedTransport<Thermo>::readTable
(
...
template<class Thermo>
Foam::TwoPhaseFlow::tabulatedTransport<Thermo>::tabulatedTransport
(
...
template<class Thermo>
void Foam::TwoPhaseFlow::tabulatedTransport<Thermo>::write(Ostream& os) const
{
