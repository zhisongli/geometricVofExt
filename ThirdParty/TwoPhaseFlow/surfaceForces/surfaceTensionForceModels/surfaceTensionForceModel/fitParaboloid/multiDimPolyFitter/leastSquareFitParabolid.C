...
Foam::cartesianCS Foam::TwoPhaseFlow::leastSquareFitParabolid::makeLocalCoordSystem
(
...
Foam::TwoPhaseFlow::leastSquareFitParabolid::leastSquareFitParabolid
(
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
Foam::scalarField Foam::TwoPhaseFlow::leastSquareFitParabolid::fitParaboloid
(
    const point& centre,
    const vector& normal,
...
// Foam::Map < Foam::vector >  Foam::TwoPhaseFlow::leastSquareFitParabolid::grad
// (
