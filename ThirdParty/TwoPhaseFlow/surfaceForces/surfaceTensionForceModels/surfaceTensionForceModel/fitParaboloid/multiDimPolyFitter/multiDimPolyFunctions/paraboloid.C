...
Foam::TwoPhaseFlow::paraboloid::paraboloid
(
...
// * * * * * * * * * * * * * * * Member Functions  * * * * * * * * * * * * * //
// Foam::scalar Foam::TwoPhaseFlow::paraboloid::value(const vector2D& vec)
// {
//     // size has to be 3
//     return coeffs_[0] + coeffs_[1]*vec.x() + coeffs_[2]*vec.y();
// }

Foam::scalar Foam::TwoPhaseFlow::paraboloid::value(const vector& vec)
{
    // size has to be 4
...
// Foam::scalarField Foam::TwoPhaseFlow::paraboloid::termValues(const vector2D& vec)
// {
//     // size has to be 3
...
const Foam::scalarField& Foam::TwoPhaseFlow::paraboloid::termValues(const vector& vec)
{
