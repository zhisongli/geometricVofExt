...
Foam::autoPtr<Foam::TwoPhaseFlow::multiDimPolyFunctions> Foam::TwoPhaseFlow::multiDimPolyFunctions::New
(
...
Foam::TwoPhaseFlow::multiDimPolyFunctions::multiDimPolyFunctions(const Vector<label> dirs)
: 
nTerms_(-1),
...
Foam::TwoPhaseFlow::multiDimPolyFunctions::~multiDimPolyFunctions()
{}
