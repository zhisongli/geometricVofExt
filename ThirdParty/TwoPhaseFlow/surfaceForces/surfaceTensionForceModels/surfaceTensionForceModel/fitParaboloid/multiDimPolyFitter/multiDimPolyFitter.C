...
template<class T>
Foam::TwoPhaseFlow::multiDimPolyFitter<T>::multiDimPolyFitter
(
...
template<class T>
void Foam::TwoPhaseFlow::multiDimPolyFitter<T>::resetMatrix()
{
...
template<class T>
void Foam::TwoPhaseFlow::multiDimPolyFitter<T>::fillMatrix
(
...
template<class T>
Foam::Field<T> Foam::TwoPhaseFlow::multiDimPolyFitter<T>::fitData
(
...
template<class T>
Foam::scalarSymmetricSquareMatrix Foam::TwoPhaseFlow::multiDimPolyFitter<T>::computeInverse
(
    const List<scalarField>& listPolyTerms
)
{
...
template<class T>
Foam::Field<T> Foam::TwoPhaseFlow::multiDimPolyFitter<T>::computeMatrixSource
(
    const List<scalarField>& listPolyTerms,
    const List<T>& listValue
)
...
template class Foam::TwoPhaseFlow::multiDimPolyFitter<Foam::scalar>;
template class Foam::TwoPhaseFlow::multiDimPolyFitter<Foam::vector>;
