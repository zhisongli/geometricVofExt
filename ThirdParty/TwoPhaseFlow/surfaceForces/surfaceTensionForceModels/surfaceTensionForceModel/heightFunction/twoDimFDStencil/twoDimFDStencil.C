...
Foam::label Foam::TwoPhaseFlow::twoDimFDStencil::arrayToList(const label& i,const label& j)
{
...
Foam::label Foam::TwoPhaseFlow::twoDimFDStencil::arrayToList3D
(
    const label& i,
    const label& j,
    const label& k
...
// * * * * * * * * * * * * * * * * Constructors  * * * * * * * * * * * * * * //
Foam::TwoPhaseFlow::twoDimFDStencil::twoDimFDStencil()
:
    twoDim_(false),
    heights_(9,0.0),
    dir_(0),
...
Foam::scalar
Foam::TwoPhaseFlow::twoDimFDStencil::calcCurvature(const scalar DeltaX)
{
...
Foam::scalar
Foam::TwoPhaseFlow::twoDimFDStencil::addColumnHeight(const scalarList& stencilValues)
{
...
Foam::TwoPhaseFlow::twoDimFDStencil::nextCell(HFStencil::orientation orientation)
{
...
Ostream& operator<<(Ostream& os, const twoDimFDStencil& FDS)
{
...
Istream& operator>>(Istream& is, twoDimFDStencil& FDS)
{
    is  >> FDS.twoDim_
        >> FDS.heights_
        >> FDS.dir_
...
bool Foam::TwoPhaseFlow::twoDimFDStencil::operator==
(
