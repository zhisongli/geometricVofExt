...
Foam::TwoPhaseFlow::markInterfaceRegion::coupledFacesPatch() const
{
...
void Foam::TwoPhaseFlow::markInterfaceRegion::markCellsNearSurf
(
...
Foam::TwoPhaseFlow::markInterfaceRegion::markInterfaceRegion
(
    const fvMesh& mesh
)
:
