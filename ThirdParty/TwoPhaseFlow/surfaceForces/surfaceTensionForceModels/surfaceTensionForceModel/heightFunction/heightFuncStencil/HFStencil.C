...
void Foam::TwoPhaseFlow::HFStencil::findCuboids()
{
...
Foam::label Foam::TwoPhaseFlow::HFStencil::categorizePoint
(
    const scalar pos
)
{
...
Foam::label Foam::TwoPhaseFlow::HFStencil::calcPosInStencil
(
    const vector& cc,
    const vector& neic
)
...
void Foam::TwoPhaseFlow::HFStencil::sortStencilToIJKFormat
(
    const label celli,
...
Foam::label Foam::TwoPhaseFlow::HFStencil::arrayToList3D(const label i,const label j,const label k)
{
...
Foam::label Foam::TwoPhaseFlow::HFStencil::getCellLabel
(
    const label celli,
...
Foam::TwoPhaseFlow::HFStencil::HFStencil(const fvMesh& mesh,const scalar angleTolerance)
:
    mesh_(mesh),
...
void Foam::TwoPhaseFlow::HFStencil::updateStencil(const boolList& nextToInterface)
{
...
Foam::Map< Foam::scalar> Foam::TwoPhaseFlow::HFStencil::getDatafromOtherProc
(
