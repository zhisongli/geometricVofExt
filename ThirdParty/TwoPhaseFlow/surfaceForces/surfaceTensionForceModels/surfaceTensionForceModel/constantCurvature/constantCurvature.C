...
Foam::TwoPhaseFlow::constantCurvature::constantCurvature
(
...
void Foam::TwoPhaseFlow::constantCurvature::correctContactAngle
(
...
void Foam::TwoPhaseFlow::constantCurvature::correct()
{
