...
Foam::TwoPhaseFlow::surfaceTensionModels::constant::constant
(
...
Foam::TwoPhaseFlow::surfaceTensionModels::constant::sigma() const
{
...
bool Foam::TwoPhaseFlow::surfaceTensionModels::constant::readDict(const dictionary& dict)
{
...
bool Foam::TwoPhaseFlow::surfaceTensionModels::constant::writeData(Ostream& os) const
{
