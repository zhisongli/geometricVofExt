...
Foam::TwoPhaseFlow::surfaceTensionModels::temperatureDependent::temperatureDependent
(
...
Foam::TwoPhaseFlow::surfaceTensionModels::temperatureDependent::sigma() const
{
...
bool Foam::TwoPhaseFlow::surfaceTensionModels::temperatureDependent::readDict
(
    const dictionary& dict
)
{
...
bool Foam::TwoPhaseFlow::surfaceTensionModels::temperatureDependent::writeData
(
    Ostream& os
) const
{
