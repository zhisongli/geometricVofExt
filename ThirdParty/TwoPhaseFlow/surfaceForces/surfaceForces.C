...
Foam::TwoPhaseFlow::surfaceForces::surfaceForces
(
...
Foam::tmp<Foam::surfaceScalarField> Foam::TwoPhaseFlow::surfaceForces::surfaceTensionForce()
{
    return surfTenForceModel_->surfaceTensionForce();
}

Foam::tmp<Foam::surfaceScalarField> Foam::TwoPhaseFlow::surfaceForces::accelerationForce()
{
    return accModel_->accelerationForce();
}

Foam::scalar Foam::TwoPhaseFlow::surfaceForces::capillaryDt
(
