...
Foam::TwoPhaseFlow::gravity::gravity
(
...
void Foam::TwoPhaseFlow::gravity::calculateAcc()
{
...
Foam::tmp<Foam::surfaceScalarField> Foam::TwoPhaseFlow::gravity::accelerationForce()
{
    const fvMesh& mesh = acc_.mesh();
